...
export const translations = {
  ...
  bs: {
    ...
    pricing: {
      ...
      webPlans: [
        { name: "Basic",    tag: "Jednostavna prezentacija za male firme",      price: "€299",   gift: "Start",      maint: "€25/mj", cont: "€30/mj",
          features: ["Landing stranica (1 stranica)", "Prikaz do 8 vozila", "Kontakt forma", "1 jezik · mobilna optimizacija"] },
        { name: "Standard", tag: "Kompletno rješenje za ozbiljan rent-a-car",   price: "€649",   gift: "Rast",       maint: "€45/mj", cont: "€75/mj",
        ...
        { name: "Premium",  tag: "Custom rješenje s naprednim funkcijama",       price: "€1.249", gift: "Dominacija", maint: "€75/mj", cont: "€125/mj",
  ...
  en: {
    ...
    pricing: {
      ...
      webPlans: [
        { name: "Basic",    tag: "Simple presentation for small businesses",        price: "€299",   gift: "Start",      maint: "€25/mo", cont: "€30/mo",
          features: ["Landing page (1 page)", "Up to 8 vehicles displayed", "Contact form", "1 language · mobile optimized"] },
        { name: "Standard", tag: "Complete solution for a serious rent-a-car",       price: "€649",   gift: "Growth",     maint: "€45/mo", cont: "€75/mo",
        ...
        { name: "Premium",  tag: "Custom solution with advanced features",           price: "€1,249", gift: "Domination", maint: "€75/mo", cont: "€125/mo",
