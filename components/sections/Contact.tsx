...
const T: Record<"bs" | "en", Content> = {
  bs: {
    ...
    steps: [
      { t: "Pošaljete upit",          d: "Dvije minute posla: recite nam šta vam treba, svojim riječima." },
    ...
    subjectOptions: ["Web sajt", "Web aplikacija", "Digitalni marketing", "AI integracija", "Ostalo"],
    messageLabel: "Poruka",
  ...
  en: {
    ...
    steps: [
      { t: "Send an inquiry",      d: "Two minutes of work: tell us what you need, in your own words." },
    ...
    subjectOptions: ["Website", "Web application", "Digital marketing", "AI integration", "Other"],
