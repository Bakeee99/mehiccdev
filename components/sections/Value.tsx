 ...
 *       samo održavanje €60/mj →  od €2,00/dan (manje od jedne kafe)
...
const T: { bs: Content; en: Content } = {
  bs: {
    ...
    sub: "Starter aplikacija razvučena na prvu godinu ispadne oko tri i po eura dnevno, a mjesečno održavanje manje od jedne kafe. I radi za vas non-stop.",
    cards: [
      { label: "KOMPLETNA APLIKACIJA", lt: "od", big: "€3,50", per: "/dan", capPre: "prva godina · zatim je ", capStrong: "zauvijek vaša" },
  ...
  en: {
    ...
    sub: "Spread over the first year, a Starter app comes to about three and a half euros a day, and monthly support costs less than a coffee. And it works for you non-stop.",
    cards: [
      { label: "COMPLETE APP", lt: "from", big: "€3.50", per: "/day", capPre: "first year · then it's ", capStrong: "yours forever" },
