...
export function Services() {
  ...
  return (
    <section id="usluge" className="py-28 lg:py-36 relative overflow-hidden">
      ...
      <div className="absolute -right-56 top-16 w-96 h-96 rounded-full bg-brand-600/5 blur-3xl pointer-events-none" aria-hidden />
      <div className="absolute -left-56 bottom-16 w-96 h-96 rounded-full bg-brand-600/5 blur-3xl pointer-events-none" aria-hidden />
